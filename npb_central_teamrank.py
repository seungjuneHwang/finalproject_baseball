...
url = "https://sports.news.naver.com/wbaseball/record/index?category=npb&league=CL&year=2023"
...
for tr_tag in soup.find(id='regularTeamRecordList_table').find_all('tr'):
    ...
    print(lank, " ", team, " ",  total, "| 경기수 :", win, "| 승 :", lose, "| 패 :", winper, "| 승률 :", rate, "| 게임차 :", gab, "| 연속 :", contin, "| 출루율 :", gobase, "| 장타율 :", longhit, "| 최근10경기 :", lately)
